                        ...
                        success: function (response) {
                            if (response.getParticipantsResponse.totalNumberResults === '0') {
                                ...
                                $(participants).each(function (i, participant) {
                                    ...
                                    $('#team-roster tbody').append('<tr class="' + (i > 4 ? 'd-none' : '') + '"><td class="donor-name">' + (participant.aTeamCaptain === "true" ? ' <span class="coach"><img alt="Team Captain" src="https://secure3.convio.net/heartdev/images/content/pagebuilder/team-roster-icon--captain.png"></span>' : '') + '<a href="' + participant.personalPageUrl + '">' +
                                        participant.name.first + ' ' + participant.name.last +
