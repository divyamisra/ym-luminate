      ...
      if(!jQuery(this).hasClass('js--team-member-donate')){
        if (jQuery(this).next('.paymentSelType').length > 0) {
          ...
          if(jQuery(this).parent().parent().parent().parent().hasClass('table')) {
            var html = "<tr><td><div class='paymentSelType text-center' style='padding-top:10px;'>" +
              ...
              "<a href='"+dlink+"&paypal=true'><img src='https://www2.heart.org/images/content/pagebuilder/PP_logo_h_100x26.png'/ alt='Donate with PayPal'></a></td></tr>";
