          ...
          angular.forEach prizes, (prize) ->
            ...
            if prize.mission_url_type == 'Quiz' 
              if $scope.tablePrefix == 'heartdev'
                final_url = 'https://tools.heart.org/aha_ahc24_dev/quiz/show/' + prize.mission_url + '?event_id=' + $scope.frId + '&user_id=' + $scope.consId + '&name=' + $scope.consNameFirst
              if $scope.tablePrefix == 'heartnew'
                final_url = 'https://tools.heart.org/aha_ahc24_testing/quiz/show/' + prize.mission_url + '?event_id=' + $scope.frId + '&user_id=' + $scope.consId + '&name=' + $scope.consNameFirst
              if $scope.tablePrefix == 'heart'
                final_url = 'https://tools.heart.org/aha_ahc24/quiz/show/' + prize.mission_url + '?event_id=' + $scope.frId + '&user_id=' + $scope.consId + '&name=' + $scope.consNameFirst
