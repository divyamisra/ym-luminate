          ...
          angular.forEach prizes, (prize) ->
            ...
            if prize.hq_action_type == 'Quiz' 
              if $scope.tablePrefix == 'heartdev'
                final_url = 'https://tools.heart.org/aha_ym24_dev/quiz/show/' + prize.hq_action_url + '?event_id=' + $scope.frId + '&user_id=' + $scope.consId + '&name=' + encodeURI($scope.consNameFirst)
              if $scope.tablePrefix == 'heartnew'
                final_url = 'https://tools.heart.org/aha_ym24_testing/quiz/show/' + prize.hq_action_url + '?event_id=' + $scope.frId + '&user_id=' + $scope.consId + '&name=' + encodeURI($scope.consNameFirst)
              if $scope.tablePrefix == 'heart'
                final_url = 'https://tools.heart.org/aha_ym24/quiz/show/' + prize.hq_action_url + '?event_id=' + $scope.frId + '&user_id=' + $scope.consId + '&name=' + encodeURI($scope.consNameFirst)
