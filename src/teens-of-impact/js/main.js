    ...
    $(document).ready(function($) {
        ...
        $('.js--header-company-search').on('submit', function(e) {
            ...
            if ($('body').is('.pg_Toi_General') || $('body').is('.pg_Toi_Landing_Page')) {
                window.location.href = luminateExtend.global.path.secure + 'SPageServer/?pagename=TOI_Search&search_type=company&cross_event=true&company=' + companySearched
            } else {
                window.location.href = luminateExtend.global.path.secure + 'SPageServer/?pagename=TOI_Search&search_type=company' + (evID ? '&cross_event=false&fr_id=' + evID : '&cross_event=true') + '&company=' + companySearched
            }
        })
        ...
        $('.js--header-zip-search').on('submit', function(e) {
            ...
            if ($('body').is('.pg_Toi_General') || $('body').is('.pg_Toi_Landing_Page')) {
                window.location.href = luminateExtend.global.path.secure + 'SPageServer/?pagename=TOI_Search&search_type=zip&cross_event=true&zip=' + zipSearched
            } else {
                window.location.href = luminateExtend.global.path.secure + 'SPageServer/?pagename=TOI_Search&search_type=zip' + (evID ? '&cross_event=false&fr_id=' + evID : '&cross_event=true') + '&zip=' + zipSearched
            }
        })
        ...
        $('.js--header-state-search').on('submit', function(e) {
            ...
            if ($('body').is('.pg_Toi_General') || $('body').is('.pg_Toi_Landing_Page')) {
                window.location.href = luminateExtend.global.path.secure + 'SPageServer/?pagename=TOI_Search&search_type=state&cross_event=true&state=' + stateSearched
            } else {
                window.location.href = luminateExtend.global.path.secure + 'SPageServer/?pagename=TOI_Search&search_type=state' + (evID ? '&cross_event=false&fr_id=' + evID : '&cross_event=true') + '&state=' + stateSearched
            }
        })
        ...
        $('#stateSearch').on('change', function() {
            var stateSearch = encodeURIComponent($('#stateSearch').val())
            if ($('body').is('.pg_Toi_General') || $('body').is('.pg_Toi_Landing_Page')) {
                window.location.href = luminateExtend.global.path.secure + 'SPageServer/?pagename=TOI_Search&search_type=state&cross_event=true&state=' + stateSearch
            } else {
                window.location.href = luminateExtend.global.path.secure + 'SPageServer/?pagename=TOI_Search&search_type=state' + (evID ? '&cross_event=false&fr_id=' + evID : '&cross_event=true') + '&state=' + stateSearch
            }
        })
        ...
        $('.js--header-participant-search').on('submit', function(e) {
            ...
            if ($('body').is('.pg_Toi_General') || $('body').is('.pg_Toi_Landing_Page')) {
                window.location.href = luminateExtend.global.path.secure + 'SPageServer/?pagename=TOI_Search&search_type=participant&cross_event=true' + (firstName ? '&first_name=' + firstName : '') + (lastName ? '&last_name=' + lastName : '')
            } else {
                window.location.href = luminateExtend.global.path.secure + 'SPageServer/?pagename=TOI_Search&search_type=participant' + (evID ? '&cross_event=false&fr_id=' + evID : '&cross_event=true') + (firstName ? '&first_name=' + firstName : '') + (lastName ? '&last_name=' + lastName : '')
            }
        })
        ...
        if ($('body').is('.pg_entry')) {
            ...
            $('.js--greeting-participant-search-form').on('submit', function(e) {
                ...
                window.location.href = luminateExtend.global.path.secure + 'SPageServer/?pagename=TOI_Search&search_type=participant&cross_event=false&fr_id=' + evID + (firstName ? '&first_name=' + firstName : '') +
            ...
            $('.js--greeting-team-search-form').on('submit', function(e) {
                ...
                window.location.href = luminateExtend.global.path.secure + 'SPageServer/?pagename=TOI_Search&search_type=team&cross_event=false&fr_id=' + evID + '&team_name=' + teamName
            })
                    ...
                    callback: {
                        success: function(response) {
                            ...
                            if (response.getPersonalVideoUrlResponse.videoUrl) {
                                ...
                                videoEmbedHtml = '<iframe cc_load_policy=1 class="embed-responsive-item" src="' + personalVideoEmbedUrl + '" title="American Heart Association Teens of Impact Video" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
                            } else {
                                // TODO - show default video
                                videoEmbedHtml = '<iframe cc_load_policy=1 width="560" height="315" src="https://www.youtube.com/embed/LryhjU1bEC4" title="About American Heart Association Teens of Impact" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
                            }
        ...
        if ($('body').is('.pg_company')) {
            ...
            var end_pos = pageTitle.indexOf('- Teens of Impact', start_pos)
        ...
        if ($('body').is('.pg_Toi_Landing_Page')) {
