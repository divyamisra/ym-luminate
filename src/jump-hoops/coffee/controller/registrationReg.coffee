      ...
      $scope.$watch 'participationType.id', (newValue) ->
        if newValue
          ...
          setRegistrationQuestionSurveyKey = (questionName, surveyKey) ->
            ...
            else if questionLegend isnt 'Event Date' and surveyKey isnt 'ym_hoops_jump_challenge_info' and surveyKey isnt 'ym_hoops_jump_ecards_sent' and surveyKey isnt 'ym_hoops_jump_ecards_shared' and surveyKey isnt 'ym_hoops_jump_ecards_open' and surveyKey isnt 'ym_hoops_jump_ecards_clicked' and surveyKey isnt 'ym_hoops_jump_ym_game_points' and surveyKey isnt 'bb_facebook_connector_id'
