                                ...
                                luminateExtend.api({
                                  ...
                                  callback: {
                                    success: function (response) {
                                      ...
                                      var topTeamRow = `<div class="col-md-4 pt-md-3 px-md-3"><div class="bg-red-deep pb-1 pt-3 px-3" style="aspect-ratio: 1/1;"><a href="TR/?team_id=${teamId}&amp;pg=team&amp;fr_id=${eventId}" class="d-flex fa flex-column h-100 justify-content-end overflow-hidden position-relative rounded-circle text-center text-decoration-none" aria-hidden="true"><img class="img-fluid position-absolute w-100" src="${teamImages[0].customUrl}" alt="" style="left: 50%; transform: translateX(-50%); top: 0;"><p class="bg-red-deep position-relative py-2 text-white __web-inspector-hide-shortcut__"><strong>Monica's Team</strong></p></a></div><div class="bg-red-deep"><a href="TR/?team_id=${teamId}&amp;pg=team&amp;fr_id=${eventId}" class="text-center text-decoration-none"><p class="py-2 text-white"><strong>${teamName}</strong></p></a></div></div>`;
