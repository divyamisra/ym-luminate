                                ...
                                luminateExtend.api({
                                    ...
                                    callback: {
                                        success: function(response) {
                                            ...
                                            var topTeamRow = `<div class="col-sm-6 col-md-4 pt-md-3 px-md-3"><a href="TR/?team_id=${teamId}&amp;pg=team&amp;fr_id=${eventId}"><div class="bg-red-deep"><div><img class="w-100" src="${teamImage}" alt="Photo of ${teamName}"></div></div><div class="align-items-center bg-red-deep d-flex justify-content-center text-center"><p class="py-2 text-white"><strong>${teamName}</strong></p></div></a></div>`
